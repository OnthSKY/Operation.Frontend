...
export const dialogTheme = {
  ...
  panel:
    "max-h-[min(96dvh,calc(100svh-max(env(safe-area-inset-top),0.25rem)-max(env(safe-area-inset-bottom),0.25rem)-0.5rem))] w-full max-w-[min(28rem,calc(100vw-1rem))] overflow-y-auto overscroll-contain rounded-xl border border-zinc-200 bg-white p-4 shadow-lg sm:max-w-md sm:p-6 md:max-w-lg lg:max-w-3xl xl:max-w-5xl 2xl:max-w-6xl xl:p-8",
