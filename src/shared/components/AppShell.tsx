  ...
  const sidebarBody = (
    <>
      <div className="relative px-2 pb-4 pt-5 md:pt-6">
        ...
        <div className={`${navItemRow} mt-2`}>
          <Link
            href="/guide/sales-deck"
            onClick={() => setMobileNavOpen(false)}
            className={`${navLinkBase} min-h-11 min-w-0 px-3 py-2 ring-1 ring-emerald-200/90 bg-gradient-to-r from-emerald-50/95 to-teal-50/70 text-emerald-950 shadow-sm hover:from-emerald-100/90 hover:to-teal-100/60 hover:ring-emerald-300/80 active:scale-[0.99] motion-reduce:active:scale-100 ${
              pathname.startsWith("/guide/sales-deck") ? "ring-2 ring-emerald-400/50" : ""
            }`}
          >
            <svg
              width="18"
            ...
            <span className="min-w-0 font-bold">{t("nav.salesDeck")}</span>
          </Link>
          <div className={navHintCol}>
            <NavMenuHint hintKey="nav.tooltip.salesDeck" />
          </div>
        </div>
      </div>
      <nav
                  ...
                  <>
                    ...
                    <div className={navItemRow}>
                      <Link
                        ...
                        onClick={() => setMobileNavOpen(false)}
                        className={`${navLinkBase} min-w-0 py-2 pl-4 pr-2 ${
                          pathname.startsWith("/products/order-account-statement/summary")
                            ? navLinkActive
                            : navLinkIdle
                        }`}
                      >
                        <NavGlyph name="reportTable" />
                        <span className="min-w-0">{t("reports.sidebarCounterpartySummary")}</span>
                      </Link>
                      <div className={navHintCol}>
                        <NavMenuHint hintKey="nav.tooltip.productsOrderAccountStatement" />
                      </div>
