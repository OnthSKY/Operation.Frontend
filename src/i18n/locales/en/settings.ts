export const settings = {
  ...
  brandingSectionBankAccounts: "Institution IBAN accounts",
  brandingSectionBankAccountsHint:
    "Manage institution bank accounts used to auto-fill invoice payment details. Choose one default account.",
  brandingBankAccountAdd: "Add account",
  brandingBankAccountRemove: "Remove",
  brandingBankAccountDefault: "Default invoice account",
  brandingBankAccountsEmpty: "No institution account added yet.",
  brandingBankAccountDisplayName: "Account name",
  brandingBankAccountIban: "IBAN",
  brandingBankAccountHolder: "Account holder",
  brandingBankAccountBankName: "Bank name",
  brandingBankAccountsDefaultValidation:
    "If at least one account exists, you must select exactly one default account.",
