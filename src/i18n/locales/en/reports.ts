...
Prior-period deltas (Î”) and branch comparisons are summarized on â€œBy branchâ€ and other sub-tabs; switch using the menu on the left.`,
  ...
  orderAccountStatementDefaultDocumentTitle: "ORDER & ACCOUNT STATEMENT",
  ...
  orderAccountStatementShipmentChange: "Change shipment",
  orderAccountStatementBrandingSection: "Document look / branding (logo, title)",
  orderAccountStatementFlowTitle: "Fill order",
  orderAccountStatementFlowStep1: "Mode",
  orderAccountStatementFlowStep2Shipment: "Pick shipment",
  orderAccountStatementFlowStep2Manual: "Document content",
  orderAccountStatementFlowStep3: "Lines & amounts",
  orderAccountStatementFlowStep4: "Preview & download",
  orderAccountStatementFlowHintShipment:
    "In the shipment-based flow, pick a shipment first; the system auto-fills lines and branch info.",
  orderAccountStatementFlowHintManual:
    "In the manual flow, fill the document content first, then lines/amounts, then go to preview.",
  orderAccountStatementModeCardTitle: "2A · Shipment / Mode",
  orderAccountStatementSelectFirstBadge: "Select this first",
  orderAccountStatementModeCardHelp:
    "This card defines where the data comes from (manual / shipment).",
  orderAccountStatementShipmentPreselectHint:
    "1) Pick a shipment, 2) lines come automatically, 3) edit only what's missing.",
