export const nav = {
  ...
  reportsFinanceSection: "Finance",
  reportsProductSection: "Product & stock",
  reportsPersonnelSection: "Personnel",
  reportsBranchSection: "Branches",
  ...
  publicSiteBranches: "Branch showcases",
  publicSiteFlavors: "Flavors",
  publicSiteContent: "Site content",
  subWarehouse: "Warehouse",
  subProducts: "Products & Pricing",
  subDefinitions: "Definitions",
  subCommercial: "Accounts & Orders",
  ...
  adminNavJobTitles: "Job titles",
  adminNavBranchExpenses: "Branch expenses",
  adminNavPersonnelExpenseTypes: "Personnel expense types",
  ...
  documents: "Documents",
  dailyBranchRegister: "Daily register",
  ...
  mobileFullMenuTitle: "Menu",
  mobileFullMenuSubtitle: "Search, use shortcuts, or the full list below",
  mobileMenuSearchPlaceholder: "Search the menu…",
  mobileMenuSearchAria: "Search the menu",
  mobileMenuSearchNoResults: "No matching menu items",
  mobileMenuSearchHint: "Filter by page name or path",
  openGroupedNavigation: "All sections & pages",
  openInSidebarPanel: "Open as slim side panel",
  mobileGroupedNavAria: "All sections and pages",
