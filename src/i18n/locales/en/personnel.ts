export const personnel = {
  ...
  costsTabContractor: "Contractors",
  costsUnifiedTableTitle: "Advance and expense lines",
  costsColType: "Type",
  costsTypeAdvance: "Advance",
  costsTypeExpense: "Expense",
  costsTypeContractorPayment: "Contractor payment",
  costsColDate: "Date",
  costsColDetail: "Source / class",
  costsColPaymentFrom: "Branch vs owner",
  costsFilterDateFrom: "Start date",
  costsFilterDateTo: "End date",
  costsTagFuture: "Upcoming",
  costsTagToday: "Today",
  costsTagThisMonth: "This month",
  costsTagPast: "Past",
  ...
  costsFilterRowKindContractor: "Contractor payments only",
  costsColWrittenFrom: "Recorded via",
  costsOriginAdvance: "Advance",
  costsOriginExpense: "Expense",
  costsOriginContractor: "Contractor payment",
  ...
  costsPatronOutAdvanceShort: "advance",
  costsPatronOutExpenseShort: "expense",
  ...
  costsKpiSectionTitle: "At a glance",
  costsKpiTotalAdvance: "Total advances",
  costsKpiTotalAdvanceHint: "{count} rows",
  costsKpiTotalExpense: "Total expenses",
  costsRowDateFuture: "Upcoming",
  costsRowDateToday: "Today",
  costsRowDateThisMonth: "This month",
  costsRowDatePast: "Past",
  costsKpiTotalExpenseHint: "{count} rows",
  costsKpiTotalPersonnel: "Total personnel cost",
  costsKpiTotalPersonnelHint: "Advances + expenses",
  costsKpiContractorExpense: "External workers (net owed)",
  costsKpiContractorOwed: "Incurred",
  ...
  costsCategoryUncategorized: "Uncategorized",
  costsCategoryCount: "{count} rows",
  costsPaymentMethodCardTitle: "By payment method",
  costsPaymentMethodCardDesc:
    "Owner pocket, personnel pocket and branch register breakdown (count + amount).",
  costsMonthlyCardTitle: "Monthly distribution",
  costsMonthlyCardDesc: "Click a month to narrow the list below to that month.",
  costsMonthlyEmpty: "No monthly data for the current filters.",
  costsMonthlyClearFilter: "Clear month filter",
  costsMonthlyActiveLine: "List narrowed to {label}.",
  costsMonthlyTotalLabel: "Total",
  costsDetailSectionToggle: "More detail (owner / branch / people)",
  costsTableHeading: "Activity",
  ...
  nonAdvanceExpensesFootnote:
    "Includes salary, bonus and direct personnel expenses; advance movements live on the Advances tab.",
  ...
  handoverPatronTransferBranchLabel: "Branch",
  handoverPatronTransferMultiBranchHint: "Pocket cash spread across multiple branches — each branch is transferred separately.",
  handoverPatronTransferAvailableLabel: "Transferable balance",
  handoverPatronTransferMaxButton: "All",
  ...
  detailTabPersonnelCashPhysical: "Register cash in custody",
  detailCashPhysicalTabTitle: "Register cash in custody",
  ...
  detailMgmtCashAccountBranchBreakdownTitle: "Branch distribution (received / remaining)",
  detailMgmtCashAccountBranchBreakdownHint:
    "The summary totals above are authoritative; this list shows the distribution. Different currencies are not listed separately.",
  detailMgmtCashAccountBranchColIn: "Received",
  detailMgmtCashAccountBranchColRemaining: "Remaining",
  detailMgmtCashAccountBranchDevret: "Transfer",
  detailMgmtCashAccountBranchDevretTitle:
    "Transfer the remaining {amount} of branch {branch} to the owner",
  detailMgmtCashAccountLedgerTitle: "Bank statement",
  detailMgmtCashAccountLedgerEmpty: "No entries yet.",
  detailMgmtCashAccountLedgerFilterLabel: "Filter:",
  detailMgmtCashAccountLedgerFilterAll: "All categories",
  detailMgmtCashAccountGroupIncomingCash: "Incoming cash",
  detailMgmtCashAccountGroupPersonnelAdvance: "Personnel advance",
  detailMgmtCashAccountGroupPersonnelExpense: "Personnel expense",
  detailMgmtCashAccountGroupPersonnel: "Personnel expense/advance",
  detailMgmtCashAccountCounterpartyLabel: "Personnel:",
  detailMgmtCashAccountCounterpartyAll: "All personnel",
  detailMgmtCashAccountCounterpartyEmpty: "No personnel with activity.",
  detailMgmtCashAccountGroupBranchExpense: "Branch expense",
  detailMgmtCashAccountGroupSupplierInvoice: "Supplier invoice",
  detailMgmtCashAccountGroupGeneralExpense: "General expense",
  detailMgmtCashAccountGroupVehicleMaintenance: "Vehicle maintenance",
  detailMgmtCashAccountGroupPersonnelTransfer: "Transfer to personnel",
  detailMgmtCashAccountGroupPatronTransfer: "Transfer to patron",
  detailMgmtCashAccountLedgerFilterSearch: "Search…",
  detailMgmtCashAccountLedgerFilterEmpty: "No matching category",
  detailMgmtCashAccountLedgerIncludeReversals: "Include reversals",
  detailMgmtCashAccountLedgerReversalBadge: "Reversal",
  detailMgmtCashAccountLedgerColDate: "Date",
  detailMgmtCashAccountLedgerColDirection: "Dir",
  detailMgmtCashAccountLedgerColAmount: "Amount",
  detailMgmtCashAccountLedgerColBalanceBefore: "Balance before",
  detailMgmtCashAccountLedgerColBalanceAfter: "Balance after",
  detailMgmtCashAccountLedgerColCounterparty: "Counterparty",
  detailMgmtCashAccountLedgerColFrom: "From",
  detailMgmtCashAccountLedgerColTo: "To",
  detailMgmtCashAccountLedgerColSource: "Money source",
  ...
  detailMgmtCashAccountKindGeneralExpense: "General expense",
  detailMgmtCashAccountKindPersonnelPayout: "Personnel payout",
  detailMgmtCashAccountKindPatron: "Owner",
  detailMgmtCashAccountClassInDayClose: "Cash received (day close)",
  detailMgmtCashAccountClassPerAdvance: "Personnel advance",
  detailMgmtCashAccountClassPerSalary: "Personnel salary",
  detailMgmtCashAccountClassPerBonus: "Personnel bonus",
  detailMgmtCashAccountClassOpsFuel: "Fuel",
  detailMgmtCashAccountClassOpsCargo: "Cargo / freight",
  detailMgmtCashAccountClassOpsOther: "Other operational expense",
  detailMgmtCashAccountClassOpsInvoice: "Supplier invoice",
  detailMgmtCashAccountClassGoods: "Goods purchase",
  detailMgmtCashAccountClassTax: "Tax / fee",
  detailMgmtCashAccountClassOther: "Other expense",
  detailMgmtCashAccountClassPocketClaimTransfer: "Claim transfer to personnel",
  detailMgmtCashAccountClassPocketClaimToPatron: "Claim transfer to owner",
  detailMgmtCashAccountClassPatronDebtRepay: "Owner debt repayment",
  ...
  detailCostsCreatedBy: "Created by",
  ...
  detailMgmtSpentBreakdownTitle: "Spent — breakdown",
  detailMgmtSpentBreakdownByBranch: "By branch",
  detailMgmtSpentBucketAdvance: "Advance",
  detailMgmtSpentBucketHeldExpense: "Expense from held register cash",
  detailMgmtSpentBucketSettlesExpense: "Expense settling handover IN",
  detailMgmtSpentBucketPatronTransfer: "Transfer to owner",
  detailMgmtSpentBucketPatronRepay: "Debt repayment to owner",
  detailMgmtSpentBucketOther: "Other expense",
  detailMgmtOutflowsColParty: "Related personnel",
  detailMgmtOutflowsColDetail: "Detail",
  detailMgmtOutflowViewDetail: "View detail",
  detailMgmtHandoverInRefLink: "Handover #{id} · {date}",
  detailCostsViewDetailBranchExpense: "Open in branch expenses",
  detailCostsViewDetailPersonnelCosts: "On Costs tab",
} as const;
