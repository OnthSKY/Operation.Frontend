export const branch = {
  ...
  quickMenuStoryBranch: "Şube",
  quickCurrentAccount: "Cari hesap / tahsilat",
  quickMenuStoryRegister: "Şube kasası",
  quickMenuStoryStock: "Stok",
  ...
  branchPdfOptStockGroupByParent: "Depo girişlerini ana ürün bazında grupla",
  branchPdfOptStockGroupByParentHint:
    "Satır satır yerine ana ürün altında toplam miktar, çeşit sayısı ve (açıksa) tahmini tutar gösterilir.",
  branchPdfStockColParentProduct: "Ana ürün",
  branchPdfStockColVariety: "Çeşit",
  branchPdfStockColGroupValueEst: "Tahmini tutar (toplam)",
  ...
  branchPdfSectionRegister: "Şube kasası",
  branchPdfRegisterColType: "Yön",
  branchPdfRegisterTypeIn: "Gelirler",
  branchPdfRegisterTypeOut: "Giderler / çıkışlar",
  branchPdfRegisterDayCloseBadge: "Gün sonu",
  branchPdfTransferBadge: "Transfer",
  branchPdfTransferExcludedNote:
    "«Transfer» işaretli satırlar (patrona devir, cep/zimmet uzlaşması, P&L-dışı) kasa içi para hareketidir; üstteki özet gider/kâr toplamlarına dahil edilmez.",
  branchPdfDistOther: "Diğer",
  branchPdfDistCapPayType: "Ödeme türü",
  branchPdfDistCapIncomeType: "Tahsilat türü",
  branchPdfDistCapCashHolder: "Nakit kimde",
  branchPdfDistCapPaySource: "Ödeme kaynağı",
  branchPdfDistCapAdvanceSource: "Avans kaynağı",
  branchPdfCashHolderPatron: "Patron",
  branchPdfCashHolderBranch: "Şube kasası",
  branchPdfCashHolderPersonnel: "Personel zimmeti",
  branchPdfCashHolderUnassigned: "Atanmamış / diğer",
  branchPdfSummaryTitle: "Şube özeti — net",
  branchPdfSourceBreakdownTitle: "Ödeme kaynağı ve kategoriye göre gider toplamları",
  ...
  branchPdfOutflowColSource: "Kaynak",
  branchPdfOutflowBadgeAdvance: "Avans",
  branchPdfOutflowBadgeExpense: "Gider",
  branchPdfOutflowSubtotalAdvance: "Avans",
  branchPdfOutflowSubtotalExpense: "Gider",
  branchPdfOutflowSubtotalTotal: "Toplam",
  branchPdfSourceGrandTotal: "Genel toplam (tüm kaynaklar)",
  branchPdfDayCloseCashTitle: "Gün sonu nakit — kimde",
  branchPdfBranchCashWhereTitle: "Şubenin nakiti nerede (gün sonu)",
  branchPdfBranchCashTotal: "Toplam",
  branchPdfCashWhereWho: "Kim / nerede",
  branchPdfCashReceived: "Eline geçen",
  branchPdfCashRemaining: "Kalan bakiye",
  branchPdfAdvancesWhoFromTitle: "Personele avans — kime / nereden",
  branchPdfNoRows: "Kayıt yok",
  ...
  branchPdfTotalRegisterSpent: "Kasadan harcanan",
  branchPdfTotalRegisterSpentShort: "Kasadan",
  branchPdfTotalRegisterNetCash: "Kasa net (gelir − kasadan)",
  branchPdfTotalPatronSpent: "Patron cebinden",
  branchPdfTotalPersonnelHeldSpent: "Personel zimmetinden",
  branchPdfTotalPersonnelPocketSpent: "Personel cebinden",
  branchPdfPnlRevenue: "Hasılat",
  branchPdfPnlGrossRevenue: "Toplam hasılat",
  branchPdfPnlCashEarned: "Kazanılan nakit",
  branchPdfPnlCashInHand: "Ele geçen nakit",
  branchPdfPnlNetRevenue: "Net hasılat (kasa)",
  branchPdfPnlExpenses: "Şube gideri (kaynağa göre)",
  branchPdfPnlTotalExpense: "Toplam şube gideri",
  branchPdfPnlProfit: "Kâr (hasılat − şube gideri)",
  branchPdfPnlScopeNote:
    "Üstteki özet yalnız şube giderini ve kârını gösterir. Personel gideri ve avanslar aşağıda; kalan nakit «Şubenin nakiti nerede» kartında.",
  branchPdfPnlBranchSpend: "Bu şube için harcananlar",
  branchPdfPnlAdvancesToStaff: "Personele verilen avans",
  branchPdfModeDetail: "Detay (satır satır)",
  branchPdfModeSummary: "Özet (toplam)",
  branchPdfOptCurrentAccount: "Şube cari (sevkiyat / fatura)",
  branchPdfOptCurrentAccountHint:
    "Bu şubeye kesilen fatura tutarları, tahsilat ve kalan borç. Kalem detayı yazılmaz.",
  branchPdfCariTitle: "Şube cari — sevkiyat / fatura",
  branchPdfCariColShipment: "Belge / sevkiyat",
  branchPdfCariColTotal: "Tutar",
  branchPdfCariColCollected: "Tahsilat",
  branchPdfCariColOpen: "Kalan",
  branchPdfCariColStatus: "Durum",
  branchPdfCariStatusPaid: "Tahsil edildi",
  branchPdfCariStatusPartial: "Kısmi",
  branchPdfCariStatusOpen: "Açık",
  branchPdfCariGrandTotal: "Genel toplam",
  branchPdfSectionGroupBranch: "Şube gideri",
  branchPdfSectionGroupPersonnel: "Personel gideri",
  branchPdfSectionGroupStock: "Depo bilgileri",
  branchPdfSectionGroupOther: "Diğer",
  branchPdfOptPersonnelCombined: "Personel avans + gider",
  branchPdfPersonnelCombinedListMode: "Avans + gider: liste biçimi",
  ...
  currentAccountColPromoDiscount: "Promosyon/iskonto",
  currentAccountColPromo: "Promosyon",
  currentAccountColPromoMoney: "Para",
  currentAccountColGiftAmount: "Hediye ürün",
  currentAccountColAdvance: "Ön ödeme",
  currentAccountColOpen: "Kalan",
  currentAccountColPdf: "PDF",
  currentAccountColPdfStatus: "PDF durumu",
  currentAccountColReceiptImageStatus: "Dekont görseli",
  ...
  currentAccountReceiptImageStatusSaved: "Dekont var",
  currentAccountReceiptImageStatusMissing: "Dekont yok",
  currentAccountReceiptImageView: "Dekontu görüntüle",
  currentAccountReceiptImageDownload: "Dekontu indir",
  ...
  currentAccountReceiptImage: "Banka transfer dekontu (görsel)",
  ...
  currentAccountPdfOptionsTitle: "Şube cari PDF ayarları",
  currentAccountPdfOptionsHint:
    "PDF üzerinde hangi alanların gösterileceğini seçin. Önce ön izleyip sonra indirebilirsiniz.",
  ...
  currentAccountPdfIbanAccountHolder: "Hesap sahibi",
  ...
  currentAccountSubTabLedger: "Genel Bakiye",
  ledgerHint:
    "Müşterinin toplam borcu, alınan ödemeler ve kalan bakiyesi. Müteahhit modeline benzer.",
  ledgerTotalCharged: "Toplam borç (faturalar)",
  ledgerTotalPaid: "Alınan ödeme",
  ledgerOpenBalance: "Kalan bakiye",
  ledgerAddGeneralReceipt: "Tahsilat Girişi",
  ledgerModalApplyAll: "Tümü",
  ledgerModalApplyOpenBalance: "Açık bakiyeyi tutar alanına uygula",
  currentAccountReceiptImageBranchOnly: "Dekont yalnızca şube cariler için yüklenebilir.",
  currentAccountReceiptImageUploadCta: "Dosya seç veya kameradan çek",
  currentAccountReceiptImageReplace: "Değiştir",
  currentAccountReceiptCurrency: "Para birimi",
  ledgerHistoryTitle: "Tahsilat geçmişi",
  ledgerHistoryEmpty: "Henüz tahsilat kaydı yok.",
  ledgerReceiptLinkedToInvoice: "Fatura #{id}",
  ledgerReceiptGeneral: "Genel ödeme",
  ledgerReceiptDelete: "Sil",
  ledgerReceiptDeleted: "Tahsilat silindi.",
  ledgerReceiptCreated: "Tahsilat kaydedildi.",
  ledgerModalTitle: "Genel Cari Tahsilat",
  ledgerModalDate: "Tarih",
  ledgerModalAmount: "Tutar",
  ledgerModalKind: "Tahsilat türü",
  ledgerModalKindCash: "Nakit",
  ledgerModalKindBankTransfer: "Banka havalesi",
  ledgerModalKindCheck: "Çek",
  ledgerModalKindPromo: "Promosyon/İskonto",
  ledgerModalKindAdvance: "Ön ödeme",
  ledgerModalKindOther: "Diğer",
  ledgerModalNotes: "Açıklama (opsiyonel)",
  ledgerModalSave: "Tahsilatı kaydet",
  ledgerModalCancel: "Vazgeç",
  ledgerInvalidAmount: "Geçerli bir tutar girin.",
  ...
  documentsStartAction: "İşlem başlat",
  ...
  incomePeriodCashEarned: "Kazanılan",
  incomePeriodCashInHand: "Ele geçen",
  incomePeriodCashSpent: "Kasadan çıkan (gün içi)",
  incomeCashDistTitle: "Ele geçen nakit — nereye gitti",
  incomeCashDistPersonnel: "Personele",
  incomeCashDistPatron: "Patrona",
  incomeCashDistRemains: "Kasada kalan",
  incomeCashDistUnset: "Atanmamış",
  ...
  incomeQuickFiltersLead: "Hızlı tarih ve liste yenileme",
  noIncome: "Bu filtreye uygun gelir yok.",
  noIncomeTitle: "Bu filtreye uygun gelir yok",
  noIncomeHint: "Tarih aralığını genişletin, hızlı «Tüm tarihler» veya detaylı filtreleri deneyin.",
  noIncomeClearFilters: "Tüm filtreleri sıfırla",
  mobileJumpIncomeNavAria: "Gelir sekmesinde bölüme git",
  mobileJumpIncomeSummary: "Kümülatif özet",
  mobileJumpIncomePatron: "Patron / kasa",
  mobileJumpIncomeListDates: "Liste tarihi",
  mobileJumpIncomeLines: "Gelir listesi",
  mobileJumpExpenseNavAria: "Gider sekmesinde bölüme git",
  mobileJumpExpenseSummary: "Gider özeti",
  mobileJumpExpenseListDates: "Liste tarihi",
  mobileJumpExpenseLines: "Gider listesi",
  dashMonthPicker: "Rapor ayı",
  dashPersonnel: "Şubedeki personel",
  dashMonthIncome: "Aylık gelir",
  dashMonthExpense: "Aylık gider",
  dashMonthExpenseBreakdownTitle: "Gider kırılımı",
  dashMonthExpenseBreakdownHint:
    "Sabit ve değişken işletme gideri (OPEX) ile yatırım/demirbaş (CAPEX). Personel ve diğer kalemler kova dışıdır.",
  dashMonthExpenseFixed: "Sabit",
  dashMonthExpenseVariable: "Değişken",
  dashMonthExpenseCapex: "Yatırım / demirbaş",
  dashMonthExpenseOther: "Personel & diğer",
  dashMonthExpenseOtherHint: "Aylık gider − (sabit + değişken + yatırım): personel ve davranışsız kalemler.",
  dashMonthExpenseFamilyOps: "Operasyon",
  dashMonthExpenseFamilyCapex: "Yatırım",
  ...
  dashOpsOverviewTitle: "Operasyon özeti",
  dashInsuredPersonnel: "Sigortalı personel",
  dashInsuredPersonnelHint: "Açık sigorta dönemi olan personel adedi.",
  ...
  dashHeldRegisterCashTopHolder: "En yüksek açık bakiye",
  dashEntryDayCount: "İşlem günü adedi",
  dashEntryDayCountHint: "Yalnız seçili gün listesinde görünen farklı tarih adedi.",
  dashSelectedDayInCount: "Gelir satırı",
  dashSelectedDayOutCount: "Gider satırı",
  ...
  expenseQuickFiltersLead: "Hızlı tarih ve liste yenileme",
  expenseHeldSupplierPaymentsTitle: "Tedarikçi ödemeleri (personel zimmetinden)",
  expenseHeldSupplierPaymentsHint:
    "Bu ödemeler personelin zimmetindeki kasadan yapıldı. Gideri tedarikçi tarafında sayılır; buradaki gider toplamlarına (KPI) dahil edilmez, yalnızca bilgi amaçlıdır.",
  expenseHeldSupplierFallback: "Tedarikçi ödemesi",
  expenseHeldSupplierAllPersonnel: "Tüm personel",
  expenseHeldPersonnelFilterLabel: "Zimmet personeli",
  expenseHeldSupplierAllSuppliers: "Tüm tedarikçiler",
  expenseHeldSupplierSortDate: "Tarihe göre",
  expenseHeldSupplierSortAmount: "Tutara göre",
  expenseHeldSupplierSubtotal: "Ara toplam",
  noExpensesTitle: "Bu filtreye uygun gider yok",
  noExpensesHint:
    "Tarih aralığını genişletin, hızlı «Tüm tarihler» veya detaylı filtreleri deneyin.",
  ...
  stockInboundSectionTitle: "Şubeye gelen ürünler",
  stockQuickFiltersLead: "Hızlı tarih ve liste yenileme",
  stockScopeFiltersLead: "Ürün ve kategori kapsamı",
  stockDateFiltersLead: "Tarih aralığı",
  stockFiltersSummaryLead: "Seçili filtre özeti",
  stockFiltersScopeActiveShort: "Ürün kapsamı daraltıldı",
  stockFiltersScopeAnyShort: "Tüm ürün kapsamı",
  stockFiltersDrawerTitle: "Ürün ve tarih filtreleri",
  stockFiltersDrawerOpenButton: "Ürün ve tarih filtreleri",
  stockFiltersDrawerHint:
    "Seçimler listenin ve üst özet kartının tarih / ürün kapsamıyla uyumludur. Uygula ile listeyi yeniler ve paneli kapatır.",
  stockFiltersApplyClose: "Uygula ve kapat",
  stockFiltersResetInDrawer: "Filtreleri sıfırla",
  stockListViewModeHint: "Bu sayfadaki satırları nasıl gruplamak istediğinizi seçin.",
  stockListViewModeAria: "Stok girişi liste görünümü",
  stockListViewShipment: "Sevkiyat grubu",
  stockListViewMainProduct: "Ana ürün",
  stockReceiptsPageMainProductSummary: "Bu sayfada {{groups}} ana ürün grubu · {{lines}} satır",
  stockDetailModalTitleMainProduct: "Ana ürün — satırlar",
  stockDetailModalHintMainProduct: "Grup: {{name}}",
  stockEmptyTitle: "Bu filtreye uygun stok girişi yok",
  stockEmptyHint:
    "Tarih aralığını genişletin, «Tüm tarihler» veya ürün kapsamını sıfırlamayı deneyin.",
  stockEmptyClearFilters: "Tarih ve ürün filtresini sıfırla",
  noStockReceipts: "Kayıt yok.",
  stockColDate: "Tarih",
  stockColProduct: "Ürün",
  stockColQty: "Miktar",
  stockColWarehouse: "Kaynak depo",
  stockColCreatedBy: "Giren",
  stockColCreatedAt: "Oluşturulma",
  stockCreatedByUnknown: "Bilinmiyor",
  stockGroupRecordMeta: "Giren: {{user}} · {{date}}",
  stockReceiptsTotalsTitle: "Özet (filtreyle uyumlu)",
  stockReceiptsFilteredTotalQty: "Toplam gelen miktar",
  stockReceiptsParentBreakdownTitle: "Ana ürün kırılımı",
  stockReceiptsParentBreakdownHint: "Bu listede görünen ana ürün toplamı: {{qty}}",
  stockReceiptsParentBreakdownChildrenToggle: "{{name}} alt ürün kırılımını aç/kapat",
  stockReceiptsParentBreakdownPageOnly:
    "Not: Bu kırılım yalnızca mevcut sayfadaki satırlardan hesaplanır; filtre toplamı tüm sayfalardır.",
  ...
  stockShipmentQuickOpen: "Detay",
  stockShipmentModalTitle: "Sevkiyat detayları",
  stockShipmentModalHint: "Sevkiyat: {{shipment}}",
  stockShipmentModalHintLead: "Sevkiyat",
  stockShipmentModalViewHint: "Kalemleri nasıl görmek istediğinizi seçin.",
  stockShipmentModalViewAria: "Sevkiyat detayı görünümü",
  stockShipmentModalViewLines: "Kalem bazlı",
  stockShipmentModalViewMainProduct: "Ana ürün bazlı",
  stockShipmentModalGroupLineCount: "{{count}} kalem",
  stockShipmentModalOpenWarehouse: "Depo detayı",
  stockShipmentPhotoHeading: "Sevkiyat görseli",
  stockShipmentPhotoNone: "Bu sevkiyat için görsel eklenmemiş.",
  stockShipmentPhotoRemove: "Görseli kaldır",
  stockShipmentPhotoReplaceHint: "Yeni görsel seçince mevcut görselin yerini alır.",
  stockShipmentPhotoAddHint: "Bu sevkiyat için görsel ekleyin (JPEG/PNG/WebP).",
  stockShipmentPhotoSaved: "Sevkiyat görseli kaydedildi.",
  stockShipmentPhotoRemoved: "Sevkiyat görseli kaldırıldı.",
  filterDateFrom: "Başlangıç",
  filterDateTo: "Bitiş",
  filterApplyRefresh: "Yenile",
  txFilterAny: "Tümü",
  txFilterMainCategory: "Ana kategori",
  txFilterSubCategory: "Alt kategori",
  txFilterCategory: "Kategori",
  txFilterCashSettlement: "Nakit devri",
  txFilterExpensePayment: "Ödeme kaynağı",
  txFilterExpenseKind: "Gider türü",
  expKindOps: "İşletme gideri",
  expKindPersonnel: "Personel gideri (avans / maaş)",
  expKindSupplier: "Tedarikçi gideri (fatura)",
  expKindVehicle: "Araç bakım / yakıt",
  expKindContractor: "Dış çalışan / taşeron",
  branchPdfExpenseGroupPersonnel: "Personel zimmeti",
  expensePayRegister: "Şube kasası",
  expensePayPatron: "Patron cebi",
  expensePayPersonnelPocket: "Personel cebi",
  expensePayPersonnelHeldRegisterCash: "Personel zimmetindeki kasa parası",
  expensePayHintRegister: "Şube kasası hareketine yansır.",
  expensePayHintPatron: "Şubeden düşmez, patron öder.",
  expensePayHintPersonnelPocket: "Kasa personele borçlanır, kasadan çıkmaz.",
  expensePayHintPersonnelHeldRegisterCash: "Personel zimmetindeki kasa parasından düşülür.",
  expensePayRegisterShort: "Kasa nakit",
  expensePayPatronShort: "Patron",
  expensePayPersonnelPocketShort: "Zimmet",
  expensePayPersonnelHeldRegisterCashShort: "Zimmet",
  ...
  txColActions: "İşlem",
  txDetailTitleIncome: "Gelir kaydı detayı",
  txDetailTitleExpense: "Gider kaydı detayı",
  txDetailViewAria: "Detayı görüntüle",
  txDetailSectionGeneral: "Genel bilgi",
  txDetailSectionAmounts: "Tutar",
  txDetailSectionPayment: "Ödeme ve kasa",
  txDetailSectionLinks: "Bağlantılı kayıtlar",
  txDetailSectionNote: "Açıklama",
  txDetailGrossCash: "Kazanılan nakit",
  txDetailCardAmount: "POS / kart",
  txDetailCashAmount: "Kasaya giren nakit",
  txDetailNetIncome: "Net gelir",
  txDetailCashExpense: "Kasa gideri",
  txDetailNoNote: "Açıklama girilmemiş",
  txDeleteAria: "Bu kasa satırını sil",
  txDeleteSure: "Bu kayıt silinsin mi?",
  txDeleteConfirmMessage:
    "Satır pasifleştirilir; «Geri Al» ile 5 saniye içinde iade edebilirsiniz.",
  ...
  txColNote: "Açıklama",
  txColCreatedBy: "Yazan",
  txColKind: "Tür",
  txDetailSectionAudit: "Kayıt bilgisi",
  expenseKindAdvance: "Avans",
  expenseKindPersonnel: "Personel gideri",
  expenseKindOverhead: "Genel gider",
  expenseKindInvoice: "Fatura",
  expenseKindBranch: "Şube gideri",
  txTypeIn: "Gelir",
  txTypeOut: "Gider",
  ...
  assignPersonnelStepPickLabel: "Personel seç",
  assignPersonnelStepConfirmLabel: "Onayla",
  assignPersonnelConfirmListTitle: "Aktarılacak personel",
  assignPersonnelConfirmSummary:
    "{n} personel «{toBranch}» şubesine kaydedilecek.",
  assignPersonnelConfirmRowFromTo: "{from} → {to}",
  ...
  txStoryExpenseCallout:
    "Personel gideri: personele doğrudan elden veya havale ile verilmeyen, onun için yapılan harcama (kıyafet, market, alışveriş vb.). Doğrudan ödenen avanslar avans ekranından girilir.",
  txType: "Kayıt türü",
  txAmount: "Tutar",
  ...
  txMainOutCapex: "Yatırım / demirbaş",
  ...
  txSubContractorPayment: "Taşeron ödemesi",
  ...
  txLinkedContractor: "Taşeron",
  txGeneralOverheadPool: "Genel gider payı",
  txSubStkPurchase: "Stok alımı",
  txSubStkMaterial: "Sarf / malzeme",
  txSubStkOther: "Diğer ürün",
  txSubCapexEquipment: "Cihaz / ekipman (klima, kamera, POS)",
  txSubCapexFurniture: "Mobilya / demirbaş",
  txSubCapexFitout: "Tadilat / dekorasyon",
  txSubCapexOther: "Diğer yatırım",
  txSubOpsRent: "Kira",
  txSubOpsUtil: "Fatura / enerji",
  txSubOpsMaintenance: "Bakım / onarım",
  txSubOpsMarketing: "Pazarlama / reklam",
  txSubOpsCleaning: "Temizlik",
  txSubOpsSupplies: "Kırtasiye / ofis sarf",
  txSubOpsInsurance: "Sigorta",
  txSubOpsConsulting: "Danışmanlık (muhasebe / hukuk)",
  txSubOpsSecurity: "Güvenlik",
  txSubOpsSoftware: "Yazılım / abonelik",
  txSubOpsTraining: "Eğitim / seminer",
  txSubOpsTravel: "Seyahat / konaklama",
  txSubOpsHospitality: "Müşteri ağırlama / hediye",
  txSubOpsBankFee: "Banka masrafı (havale / işletim)",
  txSubOpsLicense: "Lisans / ruhsat / izin",
  txSubOpsTax: "Vergi",
  txSubOpsFranchise: "Franchise (royalti / pazarlama)",
  txSubOpsMeal: "Yemek",
  txSubOpsFuel: "Yakıt",
  txSubOpsCargo: "Kargo",
