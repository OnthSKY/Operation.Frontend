export const dashboard = {
  ...
  dailyRegisterTotal_expense_primary: "Gider (OUT toplamı)",
  dailyRegisterTotal_expense: "Kasadan (tahsilat − net)",
  dailyRegisterExpenseShareRegister: "Kasadan",
  dailyRegisterExpenseShareOutside: "Patron / personel cebi (kasayı aşan OUT)",
  dailyRegisterExpenseNoOutHint: "OUT satırı yok; kasa etkisi ayrı hesaplanıyor olabilir.",
  dailyRegisterTotal_net: "Net",
  dailyRegisterCardCash: "Nakit tahsilat (API)",
  dailyRegisterCardCashEarnedToday: "O gün kazanılan nakit",
  dailyRegisterCardCashSpentToday: "O gün kasadan harcanan",
  dailyRegisterCardPatronSpentToday: "O gün patronun harcadığı",
  dailyRegisterCardTotalSpentToday: "O gün harcanan toplam",
  dailyRegisterCardNetEarnings: "Gün sonu net kazanç",
  dailyRegisterCardNetByRegisterOut: "Net = kazanılan nakit − kasadan çıkan",
  dailyRegisterCardNetExpense: "Gün içinde gider net (Patron + Kasa)",
  dailyRegisterCardOtherBranchExpenses: "Şubenin diğer giderleri",
  ...
  dailyRegisterCardStaffPocketNoteTitle: "Personel cebi aktarımı",
  dailyRegisterCardStaffPocketNote: "Personel ceplerine ayrılan kasa nakit fiili gider sayılmaz; şube harcaması veya patron alana kadar bekler.",
  dailyRegisterCardPersonnelPocketCash: "Personel cebi nakit",
  dailyRegisterCardPersonnelPocketTransferredTo: "Aktarımı: personele",
  dailyRegisterCardPreviousAmount: "Önceki tutar",
  dailyRegisterCardAfterRegisterSpend: "Kasadan harcanan sonrası",
  dailyRegisterCardPersonnelPocketNetPrefix: "Kasadan harcanan çıkarıldıktan sonra net",
  dailyRegisterCardHeldRegisterCash: "Personele geçen kasa nakit",
  dailyRegisterCardHeldRegisterCashNote: "Personel ceplerine ayrılan kasa nakit, fiili gider sayılmaz.",
  ...
  dailyRegisterOpenExpenseLines: "Gider satırlarını aç",
  dailyRegisterOpenExpenseLinesAria: "Şube gider sekmesinde bu kapsamdaki satırları görüntüle",
  dailyRegisterCardTotalIncoming: "Gelen toplam",
  dailyRegisterCardTotalOutgoing: "Giden toplam",
  dailyRegisterCardRemainingCash: "Gün sonu elde kalan nakit",
  dailyRegisterCardOpenBranchDetail: "Detayı görüntüle",
  dailyRegisterCardNetResult: "Net",
  ...
  dailyRegisterCardExpenseFootnote:
    "Üstteki satırlar şube gider satırdaki «Ödeme kaynağı» ile aynıdır (kasa / patron / personel cebi / cebdeki kasa / belirtilmemiş). Alttaki yüzdeler OUT toplamına göre: kasa tarafı tahsilat − net; kalan OUT patron/personel cebi vb.",
  ...
  dailyRegisterPersonnelPocketExpense: "Personel cebi gideri",
  dailyRegisterHeldRegisterCashExpense: "Kasa dışı personel cebi gideri",
  ...
  dailyRegisterExpensePurposeLabel: "Gider amacı",
  dailyRegisterExpenseSourceLabel: "Gider kaynağı",
  dailyRegisterExpenseDestinationLabel: "Gider nereye gitti",
  dailyRegisterExpensePurposeBranch: "Şube gideri",
  dailyRegisterExpensePurposeOwner: "Patron tarafından ödenen gider",
  dailyRegisterExpensePurposePersonnel: "Personel avans / gideri",
  dailyRegisterExpensePurposeGeneral: "Genel gider",
  dailyRegisterExpenseDestinationPersonnel: "Personel avansı / gideri",
  dailyRegisterExpenseDestinationOwner: "Patron cebine veya patron kaynaklı gider",
  dailyRegisterExpenseDestinationBranch: "Şube gideri",
  dailyRegisterExpenseDestinationGeneral: "Genel / kategorisiz gider",
  dailyRegisterExpenseDestinationUnknown: "Bilinmeyen gider yönü",
  ...
  dailyRegisterExpenseSourceBranchCash: "Şube kasası",
  dailyRegisterExpenseSourceOwnerPocket: "Patron cebi",
  dailyRegisterExpenseSourceEmployeePocket: "Personel cebi",
